...
C<<< < remap="action"> >>>C<<< < class="other" otherclass="medialabel"> >>>C<<< <pubwork=""> >>>C<<< <remap=""> >>>  +-----------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | Old name                                                                                                  | New name                                                                                                                                                     |
  | --------                                                                                                  | --------                                                                                                                                                     |
  | sgmltag                                                                                                   | tag                                                                                                                                                          |
  | bookinfo, articleinfo, chapterinfo, *info                                                                 | info                                                                                                                                                         |
  ...
  | invpartnumber                                                                                             | . The productnumber element is another alternative.                                                                                                          |
  | medialabel                                                                                                | , where mediatype is the type of media being labeled (e.g.,cdrom or dvd).                                                                                    |
  | modespec                                                                                                  | No longer needed. The current processing model for olink renders modespec unnecessary.                                                                       |
  | structfield, structname                                                                                   | . In some contexts, it may also be appropriate to use property for structfield.                                                                              |
  |                                                                                                           |                                                                                                                                                              |
  +-----------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------+
